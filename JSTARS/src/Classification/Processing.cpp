...
#define LABEL_FILE "data/label/d3-alg2l.txt"
...
//    _utils->simplifyTensorLines(_probval);
//    _utils->pruneTriangles(_rmin,_probval);
        ...
        //Recording to file operations

//        _utils->label_classification(_probval);
//        _utils->writeSalToFile(_probval);
//        _utils->writeDONToFile(_probval);
//        _utils->writeNeighborsToFile(_rmin);
//        _utils->writeTriangulationToFile(_probval);
//        _utils->completeTriangulation();

//        _displayObj->writeTostl();
