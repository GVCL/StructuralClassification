...
Output Params		:
*****************************************************************************************/
void CovarianceMatrix2D::setInputCloud(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud)
{
    _inCloud = cloud;
}
/*****************************************************************************************
...
Output Params		:
*****************************************************************************************/
void CovarianceMatrix2D::setOctree(OctreeXYZ<PointT,LeafContainerT, BranchContainerT > * octree)
{
   _octree = octree;
}
/*****************************************************************************************
...
void CovarianceMatrix2D::setParams(float rmin, float rmax, float rmaxpt, float epsi, float scale)
{
    _rmin = rmin;
    _rmax = rmax;
    _rmaxpt = rmaxpt;
...
Output Params		:
*****************************************************************************************/
bool CovarianceMatrix2D::setAccumzero()
{
...
Output Params		:
*****************************************************************************************/
bool CovarianceMatrix2D::voteAccum(float radius)
{
    ...
    for(size_t i =0; i < _inCloud->points.size(); i++)
    {
        ...
        if(_octree->radiusSearch(searchPoint, radius, pointIdxRadiusSearch, pointRadiusSquaredDistance) > 0)
        {
            ...
            _accum[i].evec0[2] = 0;//covariance_matrix(0, 2);

            _accum[i].evec1[0] = covariance_matrix(1, 0);
            _accum[i].evec1[1] = covariance_matrix(1, 1);
            _accum[i].evec1[2] = 0;//covariance_matrix(1, 2);

            _accum[i].evec2[0] = 0;//covariance_matrix(2, 0);
            _accum[i].evec2[1] = 0;//covariance_matrix(2, 1);
            _accum[i].evec2[2] = 0;//covariance_matrix(2, 2);
...
*****************************************************************************************/
void CovarianceMatrix2D::prob_measure(vector <probfeatnode> *probval)
{
...
*****************************************************************************************/
bool CovarianceMatrix2D::probMeasure (vector<probfeatnode>&probfeatVal)
{
...
Output Params		:
*****************************************************************************************/
void CovarianceMatrix2D::writeGlyphVars(float radius)
{
...
Output Params		:
*****************************************************************************************/
void CovarianceMatrix2D::computeSaliencyVals(glyphVars &glyphtemp, int idx)
{
...
Output Params		:
*****************************************************************************************/
void CovarianceMatrix2D::glyphAnalysis(glyphVars &glyphtemp)
{
...
Output Params		:
*****************************************************************************************/
bool CovarianceMatrix2D::eigendecomposition(glyphVars &glyphtemp, size_t idx)
{
