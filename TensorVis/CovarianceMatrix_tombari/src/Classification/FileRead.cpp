...
*****************************************************************************************/
bool FileRead::offFileRead(string filename, CloudType &cloudData, vector <float>&intensity)
{
  bool errorCode;
  FILE *fp = fopen(filename.c_str(), "r");
  if(fp == NULL)
...
*****************************************************************************************/
bool FileRead::xyzFileRead(string filename, CloudType &cloudData, vector <float>&intensity)
{
  bool errorCode;
  FILE *fp = fopen(filename.c_str(), "r");
  if(fp == NULL)
