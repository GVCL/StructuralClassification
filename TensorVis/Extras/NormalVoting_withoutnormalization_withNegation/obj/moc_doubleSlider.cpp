...
**
** Created: Tue May 10 22:25:16 2016
...
static const char qt_meta_stringdata_DoubleSlider[] = {
    "DoubleSlider\0\0value\0doubleValueChanged(double)\0"
...
const QMetaObjectExtraData DoubleSlider::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DoubleSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_DoubleSlider,
      qt_meta_data_DoubleSlider, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DoubleSlider::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DoubleSlider))
