...
ParmWidget::ParmWidget(MainWindow *mainWnd)
{
  ...
  rminSlider = createRadiusSlider(50);
  rmaxSlider = createRadiusSlider(50);
 ...
 // connect(sigmaxSlider, SIGNAL(doubleValueChanged(double)),this,SLOT(sigmaxChanged(double)));
  ...
  connect(glWidget, SIGNAL(zRotationChanged(int)), zSlider, SLOT(setValue(int)));*/
   ...
   // mainLayout->addWidget(scaleSlider);
    ...
    rminSlider->setValue(7);
    rmaxSlider->setValue(10);
    scaleSlider->setValue(5000);
  
  
}

DoubleSlider *ParmWidget::createRadiusSlider(int value)
{
...
QSlider *ParmWidget::createScaleSlider()
{
...
void  ParmWidget::rminChanged(double value)
{
    rminLabel->setText("rmin: "+ QString::number(value) );  
}

void  ParmWidget::rmaxChanged(double value)
{
    rmaxLabel->setText("rmax: "+ QString::number(value) );  
}

void  ParmWidget::scaleChanged(int value)
{
